...
class config extends Admin_Controller {
	...
	public function index()
	{
		...
		if($this->form_validation->run() == TRUE) {
			...
			$data = $this->siteconfig->array_from_post(array('unitpay_status','unitpay_address','yad_client_id','yad_token','qiwi_num','qiwi_pass','wmid','WMR','WMZ','wm_pass','site_pwebmoney','site_pqiwi','site_pyandex','site_ppkolvo','primearea','digiid'));
			if($data['wm_pass'] == "******")
