...
class goods extends Admin_Controller {
	...
	public function edit ($id = NULL)
	{
		...
		if($this->form_validation->run() == TRUE) {
			$data = $this->goods_model->array_from_post(array('name','category','descr','iconurl','price_rub','price_dlr','type_Item','skidka','min_order','sell_method','goods','onmain','janr','yazuk','platforma','mylytplayeer','relyz','izdatel','atkiv'));
